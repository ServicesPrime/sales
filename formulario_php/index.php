...
<div class="form-content">
  <form id="main_form" action="enviar_correo.php" method="POST">
    ...
    <div class="section-title collapsible">Section 2: Client Information <span class="toggle-icon">▼</span></div>
    <div class="section-content hidden"><?php include 'form_part2_client.php'; ?></div>

    <div class="section-title collapsible">Section 3: Operational / Service Details <span class="toggle-icon">▼</span></div>
    <div class="section-content hidden"><?php include 'form_part3_operativo.php'; ?></div>

    <div class="section-title collapsible">Section 4: Economic Information <span class="toggle-icon">▼</span></div>
    <div class="section-content hidden"><?php include 'form_part4_economico.php'; ?></div>

    <div class="section-title collapsible">Section 5: Contract Information <span class="toggle-icon">▼</span></div>
    <div class="section-content hidden"><?php include 'form_part5_contrato.php'; ?></div>

    <div class="section-title collapsible">Section 6: Observations <span class="toggle-icon">▼</span></div>
    <div class="section-content hidden"><?php include 'form_part6_observaciones.php'; ?></div>

    <div class="section-title collapsible">Section 7: Scope of Work <span class="toggle-icon">▼</span></div>
    <div class="section-content hidden"><?php include 'form_part7_scope.php'; ?></div>
